...
public class BoxSet {
    public static void main(String[] args) {
        ...
        Set<Integer> boxA = new HashSet<>(Arrays.asList(1, 2, 3));
        Set<Integer> boxB = new HashSet<>(Arrays.asList(2, 3, 4));
        Set<Integer> boxC = new HashSet<>(Arrays.asList(4, 5, 6));
        Set<Integer> boxD = new HashSet<>(Arrays.asList(5, 6, 7));

        Set<Integer>[] Boxes = new Set[]{boxA, boxB, boxC, boxD};

        Set<Integer> guessedNumberSet = new HashSet<>(Arrays.asList(1, 2, 3, 4, 5, 6, 7));
